...
This repository contains the code of the [Angular Core Deep Dive](https://angular-university.io/course/angular-components).
...
We can install the master branch using the following commands:
    ...
    git clone https://github.com/angular-university/angular-components.git
